...
def _build_result(
    ...
    return NationalEconomyClassificationResult(
        ...
        industry_major_code=classification.industry_major_code,
        industry_category_name=classification.industry_category_name,
        industry_middle_code=classification.industry_middle_code,
        industry_middle_name=classification.industry_middle_name,
        industry_name=classification.industry_name,
        loan_industry_code=classification.loan_industry_code,
        loan_industry_major_code=classification.loan_industry_major_code,
        loan_industry_category_name=classification.loan_industry_category_name,
        loan_industry_middle_code=classification.loan_industry_middle_code,
        loan_industry_middle_name=classification.loan_industry_middle_name,

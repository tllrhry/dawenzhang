...
export type FiveArticlesScenarioId = typeof TECHNOLOGY_FINANCE_SCENARIO | typeof GREEN_FINANCE_SCENARIO | typeof PENSION_FINANCE_SCENARIO | typeof DIGITAL_FINANCE_SCENARIO
export type ScenarioId = typeof NATIONAL_ECONOMY_SCENARIO | FiveArticlesScenarioId
export type ComingSoonScenarioId = 'agriculture_related' | 'inclusive_finance'
...
export const fiveArticlesScenarioIds: readonly FiveArticlesScenarioId[] = [TECHNOLOGY_FINANCE_SCENARIO, GREEN_FINANCE_SCENARIO, PENSION_FINANCE_SCENARIO, DIGITAL_FINANCE_SCENARIO]
...
export const comingSoonScenarios: ReadonlyArray<{ id: ComingSoonScenarioId; name: string }> = [{ id: 'agriculture_related', name: '涉农分类' }, { id: 'inclusive_finance', name: '普惠金融' }]
export function isFiveArticlesScenario(scenarioId: ScenarioId): scenarioId is FiveArticlesScenarioId { return scenarioId !== NATIONAL_ECONOMY_SCENARIO }

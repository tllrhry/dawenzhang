...
export type ComingSoonScenarioId = 'agriculture_related'
...
export const comingSoonScenarios: ReadonlyArray<{ id: ComingSoonScenarioId; name: string }> = [{ id: 'agriculture_related', name: '涉农分类' }]
